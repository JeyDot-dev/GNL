...
./a.out | cat -e
echo  "\n			----- file 3 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=1 get_next_line.c tst3.c 
./a.out | cat -e
echo  "\n			----- file 4 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=1 get_next_line.c tst4.c 
./a.out | cat -e
...
./a.out | cat -e
echo  "\n			----- file 3 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=10 get_next_line.c tst3.c 
./a.out | cat -e
echo  "\n			----- file 4 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=10 get_next_line.c tst4.c 
./a.out | cat -e
...
./a.out | cat -e
echo  "\n			----- file 3 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=17 get_next_line.c tst3.c 
./a.out | cat -e
echo  "\n			----- file 4 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=17 get_next_line.c tst4.c 
./a.out | cat -e
...
./a.out | cat -e
echo  "\n			----- file 3 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=42 get_next_line.c tst3.c 
./a.out | cat -e
echo  "\n			----- file 4 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=42 get_next_line.c tst4.c 
./a.out | cat -e
...
./a.out | cat -e
echo  "\n			----- file 3 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=77 get_next_line.c tst3.c 
./a.out | cat -e
echo  "\n			----- file 4 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=77 get_next_line.c tst4.c 
./a.out | cat -e
...
./a.out | cat -e
echo  "\n			----- file 3 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=144 get_next_line.c tst3.c 
./a.out | cat -e
echo  "\n			----- file 4 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=144 get_next_line.c tst4.c 
./a.out | cat -e
...
./a.out | cat -e
echo  "\n			----- file 3 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=1000 get_next_line.c tst3.c 
./a.out | cat -e
echo  "\n			----- file 4 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=1000 get_next_line.c tst4.c 
./a.out | cat -e
...
./a.out | cat -e
echo  "\n			----- file 3 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=100000 get_next_line.c tst3.c 
./a.out | cat -e
echo  "\n			----- file 4 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=100000 get_next_line.c tst4.c 
./a.out | cat -e
echo  "\n\033[0;34m=====end of test eight====="
echo  "\n\033[0;31m*****test nine : BUFFER_SIZE = 1'000'000******"
echo  "\n\033[0m			----- file 1 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=10000000 get_next_line.c tst.c 
./a.out | cat -e
echo  "\n			----- file 2 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=10000000 get_next_line.c tst2.c 
./a.out | cat -e
echo  "\n			----- file 3 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=10000000 get_next_line.c tst3.c 
./a.out | cat -e
echo  "\n			----- file 4 -----"
gcc -Wextra -Werror -Wall -D BUFFER_SIZE=10000000 get_next_line.c tst4.c 
./a.out | cat -e
